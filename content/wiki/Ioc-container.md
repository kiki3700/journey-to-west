...
- 스프링의 핵심 기술중 하나로 제어의 역전을 담당한다. 프로그램의 흐름을 개발자가 제어하지 않고, 프레임워크 또는 컨터에너가 제어하는 디자인 원칙 스프링에서 직접 객체를 생성하고, 의존성을 관리할 수 있다.
- DI(의존성 주입)은 Ioc의 구체적인 구현 방법중 하나이다. 객체의 의존성ㅇ르 외부에서 주입해 주는 방식으로 관리.
